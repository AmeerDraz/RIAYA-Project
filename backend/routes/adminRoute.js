...
adminRouter.put("/doctor/:doctorId", authAdmin, updateDoctorProfile);

// Working hours management
adminRouter.get("/doctor/:doctorId/working-hours", authAdmin, getDoctorWorkingHours);
adminRouter.put("/doctor/:doctorId/working-hours", authAdmin, updateDoctorWorkingHours);
