...
const MyAppointments = () => {
    ...
    const getStatusColor = (appointment) => {
        ...
        if (appointment.payment) return "blue";
        return "yellow";
    };
                                        ...
                                        <div className="flex flex-col lg:flex-row gap-6">
                                            ...
                                            <div className="flex-shrink-0">
                                                <img
                                                    ...
                                                    onError={(e) => {
                                                        e.target.src = "https://via.placeholder.com/96x96?text=DR";
                                                    }}
                                                />
                                            </div>
                                                ...
                                                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            ...
                                                            <div>
                                                                <h4 className="text-sm font-medium text-gray-700 mb-2">Doctor's Address</h4>
                                                                <div className="space-y-1 text-sm text-gray-600">
                                                                    <p>{appointment.docData.address?.line1 || "Address not available"}</p>
